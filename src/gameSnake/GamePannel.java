...
public class GamePannel extends JPanel implements ActionListener{
	...
	final int x[] = new int[GAME_UNITS]; //snake body dimension
	final int y[] = new int[GAME_UNITS]; //snake body dimension
	int bodyParts = 6;
	int applesEaten;
...
//				g.drawLine(i*UNIT_SIZE, 0, i*UNIT_SIZE, SCREEN_HEIGHT); //vertical grid
//				g.drawLine(0, i*UNIT_SIZE, SCREEN_WIDTH, i*UNIT_SIZE); //horizontal grid
//			}
